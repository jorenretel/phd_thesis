...
In multi-dimensional spectra the dimensions of one peak correspond to the resonances frequencies of a set of different nuclei. How the nuclei are correlated to one another depends on the method used to transfer magnetization between those nuclei.
